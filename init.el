...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Anonymous Pro" :foundry "unknown" :full normal :weight normal :height 96 :width normal :full normal :full normal :full normal :full normal :full normal)))))
